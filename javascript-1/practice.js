...
// Code Here
let reduced = (accumulator, currentValue) => accumulator + currentValue; 
let total = myNumbers.reduce(reduced); 
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(elem => elem = "George"); 
