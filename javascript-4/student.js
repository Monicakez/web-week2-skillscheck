...
let me = {
    firstName: "Monica", 
    superHeroName: "Ruby Red", 
    homeTown: "Desert Ridge", 
    superPowers: ["Teleport", "mind-reader", "mind-control"] 
}

me.superPowerXP = Math.floor(Math.random() * 100) + 1
me.profileImage = `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg`
